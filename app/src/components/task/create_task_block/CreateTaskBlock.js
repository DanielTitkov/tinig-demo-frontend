...
const CreateTaskBlock = () => {
    ...
    return (
        <div>
            <Accordion>
                <AccordionPanel label="Create task">
                    <Box alignSelf="stretch" flex pad="medium">
                        <Form
                            value={value}
                            validate="blur"
                        ...
                        >
                            ...
                            >
                                <Select
                                    name="type"
                                    id="type-input-id"
                                    options={[appConfig.tasks.types.RANDOM]}
                                />
                            </FormField>
